...
<head>
    ...
    <style>
        ...
        .phone-button:active {
            ...
            outline: none;
            /* Removes outline for cleaner look */
        }
    </style>
...
<body class="overflow-x-hidden">
    ...
    <header class="nav navbar-expand-lg fixed-top">
        <div class="row justify-content-between justify-content-lg-start align-items-center align-items-lg-start">
            ...
            <div class="col-md-10 px-0 d-none d-lg-block">
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="d-flex">
                                <ul class="header-links float-left">
                                    <li>
                                        <a href="tel:0112748149"><i class="fa fa-phone"></i> Tel: 011 274 81 49</a>
                                    </li>
                                    <li>
                ...
                <nav id="navigation" class="navbar navbar-expand p-0" style="background-color: #002b49">
                            ...
                            <ul class="navbar-nav ms-auto p-1">
                                ...
                                <li class="nav-item dropdown custom-dropdown p-1">
                                    ...
                                    <ul class="dropdown-menu p-1 border">
                                        ...
                                        <li>
                                            <a href="/professionalsform"
                                                class="dropdown-item p-1 border">Professionals</a>
                                        </li>
                                        <li>
                                            <a href="#" class="dropdown-item p-1 border">Bass</a>
                                        </li>
                        ...
                        <div class="d-flex justify-content-around">
                                        ...
                                        <div class="d-flex flex-wrap">
                                            @foreach ($shopcats as $shopcat)
                                                <div class="col-6 col-md-4 mb-0">
                                                    <a
                                                        href="{{ route('category.shop', $shopcat->name) }}">{{ $shopcat->name }}</a>
                                                </div>
                                            @endforeach
                                        </div>
                                    </div>
                            ...
                            <div class="col-12 col-md-4 mb-2 mb-md-0">
                                <form action="{{ route('search') }}" method="GET"
                                    class="input-group input-group-sm w-80">
    ...
    <footer style="background: #15161d" class="text-white">
        ...
        <div class="container p-4">
            ...
            <section class="mb-4">
                <p>
                    A.A.I.C. Business Solutions (Pvt) Ltd provides accounting, marketing, IT, and business consulting
                    services in Sri Lanka. Recognizing the need for a digital platform in the construction industry, the
                    company developed BUILDERS.LK to create an integrated market.
                </p>
            </section>
        ...
        <div id="bottom-footer" class="section text-center mt-4">
            <span class="copyright">
                ...
                </script> All rights reserved | BUILDERS.LK by
