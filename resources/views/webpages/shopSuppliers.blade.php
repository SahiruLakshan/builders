        ...
        <div class="custom-form-style border p-5">
            ...
            <div class="row">
                <div class="form-group col">
                    ...
                    <input type="text" class="form-control" id="supplier_name" placeholder="Name Of The Suppliers/Shop" name="shop_name" />
                </div>
                <div class="col-12">
                    <label for="inputAddress">Address</label>
                    <textarea class="form-control" id="inputAddress" rows="2" name="address" placeholder="Address Of The Service Provider"></textarea>
                </div>
            </div>
