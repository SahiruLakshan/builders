          ...
          <aside class="app-sidebar sidebar-scroll">
            <div class="main-sidebar-header active">
              ...
              <a
                ...
                href="index.html"
                ><img src="../assets/img/brand/favicon.png" alt="logo"
              /></a>
              <a
                class="logo-icon mobile-logo icon-dark active"
                href="index.html"
                ><img src="../assets/img/brand/favicon-white.png" alt="logo"
              /></a>
            </div>
              ...
              <ul class="side-menu">
                ...
                <li class="slide">
                  <a
                    ...
                    data-bs-toggle="slide"
                    href="javascript:void(0);"
                    ><span class="side-menu__label"> Shops</span></a
                  >
                  <ul class="slide-menu">
                    <li class="side-menu__label1">
                ...
                <li class="slide">
                  <a
                    ...
                    data-bs-toggle="slide"
                    href="javascript:void(0);"
                    ><span class="side-menu__label">Product Catogory</span></a
                  >
                  <ul class="slide-menu">
                    <li class="side-menu__label1">
                    ...
                    <li>
                      <a class="slide-item" href="addCatogory.html"
                        >Add New Product Catogory
                      </a>
                    </li>
                    <li>
                      <a class="slide-item" href="icons.html"
                        >Veiw Product Catogory</a
                      >
                    </li>
                  </ul>
                </li>
                <li class="slide">
                  <a
                    ...
                    data-bs-toggle="slide"
                    href="javascript:void(0);"
                    ><span class="side-menu__label">Shop Catogory</span></a
                  >
                  <ul class="slide-menu">
                    <li class="side-menu__label1">
                ...
                <li class="slide">
                  <a
                    ...
                    data-bs-toggle="slide"
                    href="javascript:void(0);"
                    ><span class="side-menu__label">Service</span></a
                  >
                  <ul class="slide-menu">
                    <li class="side-menu__label1">
                    ...
                    <li>
                      <a class="slide-item" href="addService.html"
                        >Add New Service
                      </a>
                    </li>
                    <li>
                ...
                <li class="slide">
                  <a
                    ...
                    data-bs-toggle="slide"
                    href="javascript:void(0);"
                    ><span class="side-menu__label"> Service Providers</span></a
                  >
                  <ul class="slide-menu">
                    <li class="side-menu__label1">
                    ...
                    <li>
                      <a class="slide-item" href="addServiceProvider.html"
                        >Add New Service
                      </a>
                    </li>
                    <li>
                      <a class="slide-item" href="icons.html"
                        >Veiw Service Provider</a
                      >
                    </li>
                  </ul>
                </li>
                    ...
                    <li class="sub-slide">
                      ...
                      <ul class="sub-slide-menu">
                        ...
                        <li>
                          <a
                            class="sub-side-menu__item"
                            href="file-manager-details.html"
                            >File-Manager-Details</a
                          >
                        </li>
                        <li>
                          <a
                  ...
                  <ul class="slide-menu">
                    ...
                    <li class="sub-slide">
                      <a
                        ...
                        data-bs-toggle="sub-slide"
                        href="javascript:void(0);"
                        ><span class="sub-side-menu__label">Blog-Pages</span
                        ><i class="sub-angle fe fe-chevron-down"></i
                      ></a>
                      <ul class="sub-slide-menu">
                        <li>
                          <a class="sub-side-menu__item" href="blog.html"
                            >Blog</a
                          >
                        </li>
                        <li>
                        ...
                        <li>
                          <a class="sub-side-menu__item" href="edit-post.html"
                            >Blog-Edit</a
                          >
                        </li>
                      </ul>
                  ...
                  <ul class="slide-menu">
                    ...
                    <li class="sub-slide">
                      <a
                        ...
                        data-bs-toggle="sub-slide"
                        href="javascript:void(0);"
                        ><span class="sub-side-menu__label">Level-2</span
                        ><i class="sub-angle fe fe-chevron-down"></i
                      ></a>
                      <ul class="sub-slide-menu">
                        <li>
                        ...
                        <li class="sub-slide2">
                          <a
                            ...
                            href="javascript:void(0);"
                            ><span class="sub-side-menu__label">Level-2.3</span
                ...
                <li class="slide">
                  ...
                  <ul class="slide-menu">
                    ...
                    <li>
                      <a class="slide-item" href="form-sizes.html"
                        >Form-Sizes</a
                      >
                    </li>
                  </ul>
                ...
                <li class="slide">
                  ...
                  <ul class="slide-menu">
                    ...
                    <li>
                      <a class="slide-item" href="edit-table.html"
                        >Edit Tables</a
                      >
                    </li>
                  </ul>
                ...
                <li class="slide">
                  <a class="side-menu__item" href="widgets.html"
                    ...
                    ><span class="badge bg-warning text-dark" id="bg-side-text"
                      >Hot</span
                    ></a
                  >
                </li>
      ...
      <div class="main-footer ht-45">
        <div class="container-fluid pd-t-0 ht-100p">
          <span>
            ...
            <a href="javascript:void(0);"> Spruko </a> All rights
            reserved.</span
          >
        </div>
      </div>
