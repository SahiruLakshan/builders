...
<html lang="en">
	<head>
		...
		<title>Electro - HTML Ecommerce Template</title>
 		...
 		<link type="text/css" rel="stylesheet" href="{{ asset('assets/webpage/css/bootstrap.min.css') }}"/>
        ...
        <!-- nouislider -->
        <link type="text/css" rel="stylesheet" href="{{ asset('assets/webpage/css/nouislider.min.css') }}"/>

        <!-- Font Awesome Icon -->
        <link rel="stylesheet" href="{{ asset('assets/webpage/css/font-awesome.min.css') }}">
