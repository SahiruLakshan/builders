                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="discount" id="discount"
                                                min="0" step="0.1" placeholder="Enter Discount (%)">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="price" id="price"
                                                min="0.01" step="0.01" placeholder="Enter Unit Price">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <button type="button" id="addProductButton" class="btn btn-primary mt-4">Add Shop
                                            Item</button>
                                    </div>
                                </div>
                            </form>
        ...
        $(document).ready(function() {
            ...
            $('#product').on('change', function() {
                ...
                $.get(`/get-items/${productId}`, function(items) {
                    ...
                    items.forEach(item => {
                        $('#itemSelect').append(
                            `<option value="${item.brand.b_name} ${item.subcategory.name} ${item.productcategory.name}">${item.brand.b_name} ${item.subcategory.name} ${item.productcategory.name}</option>`
                            );
                    });
                });
            });
