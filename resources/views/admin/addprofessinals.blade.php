        ...
        <div class="card box-shadow-0">
          ...
          <div class="card-body pt-0">
            {{-- <form class="border p-4" method="POST" action="{{ route('addserviceprovider.store') }}"> --}}
              <form class=" border p-4" method="POST" action="{{route('professionals.store')}}"
                ...
                <div class="d-flex">
                  <div class="col">
                    <div class="form-group">
                      <div class=" mb-3">
                        <label for="Nmuber" class="form-label">Professional Number</label>
                        <input type="text" class="form-control" id="professionalNumber" name="professional_number">
                      </div>
                    </div>
                ...
                <div class="mb-3  d-flex">
                  ...
                  <input type="file" id="profileImage" name="profile_image" accept="image/*" onchange="previewImage()"
                    required>
          ...
          @endforeach
                ...
                <div class="d-flex flex-wrap">
                    ...
                    <div class="form-group">
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="jobTitle" name="job_title"
                          placeholder="e.g., Architect, Engineer" required>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="yearsOfExperience" name="years_of_experience"
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <div class="mb-3">
                        {{-- Professional Category neet to shgow in here this one get form professinalCategory tyble it
                        need to create contoller also --}}
                ...
                <div class="col-md-12 mb-3">
                  ...
                  <div id="certifications">
                    <div class="row certification-row">
                      <div class="col-md-4">
                        <input type="text" class="form-control mb-2" name="certification_name[]"
                          placeholder="Certification Name">
                      </div>
                      <div class="col-md-4">
                        <input type="text" class="form-control mb-2" name="issuing_authority[]"
                          placeholder="Issuing Authority">
                      </div>
                      <div class="col-md-2">
                        <input type="date" class="form-control mb-2" name="date_issued[]" placeholder="Date Issued">
                      </div>
                      <div class="col-md-2">
