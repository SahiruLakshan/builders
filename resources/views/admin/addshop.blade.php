      ...
      <div class="sticky">
        <aside class="app-sidebar sidebar-scroll">
          <div class="main-sidebar-header active">
            <a class="desktop-logo logo-light active" href="index.html"><img src="#" class="main-logo" alt="logo" /></a>
            ...
            <ul class="side-menu">
              ...
              <li class="slide">
                ...
                <ul class="slide-menu">
                  ...
                  <li>
                    <a class="slide-item" href="addBrand.html">Add New Brand
                    </a>
                  </li>
                  <li>
                    <a class="slide-item" href="icons.html">Veiw Brand</a>
                  </li>
                </ul>
              </li>
              <li class="slide">
                ...
                <ul class="slide-menu">
                  ...
                  <li>
                    <a class="slide-item" href="addShop.php">Add New Shops
                    </a>
                  </li>
                  <li>
                    <a class="slide-item" href="icons.html">view Shops</a>
                  </li>
                </ul>
              </li>
              <li class="slide">
                ...
                <ul class="slide-menu">
                  ...
                  <li>
                    <a class="slide-item" href="addShopCatogory.html">Add New Shop Catogory
                    </a>
                  </li>
                  <li>
              ...
              <li class="slide">
                ...
                <ul class="slide-menu">
                  ...
                  <li>
                    <a class="slide-item" href="addProductCatogory.html">Add New Product Catogory
                    </a>
                  </li>
                  <li>
              ...
              <li class="slide">
                ...
                <ul class="slide-menu">
                  ...
                  <li>
                    <a class="slide-item" href="addProductSubCatogory.html">Add New Product SubCatogory
                    </a>
                  </li>
                  <li>
              ...
              <li class="slide">
                ...
                <ul class="slide-menu">
                  ...
                  <li>
                    <a class="slide-item" href="addMusrment.html">Add Product Measurement
                    </a>
                  </li>
                  <li>
              ...
              <li class="slide">
                ...
                <ul class="slide-menu">
                  ...
                  <li>
                    <a class="slide-item" href="addServiceProvider.html">Add New Service Provider
                    </a>
                  </li>
                  <li>
              ...
              <li class="slide">
                ...
                <ul class="slide-menu">
                  ...
                  <li>
                    <a class="slide-item" href="draggablecards.html">Draggablecards</a>
                  </li>
                  <li>
                  ...
                  <li class="sub-slide">
                    <a class="slide-item" data-bs-toggle="sub-slide" href="javascript:void(0);"><span
                        class="sub-side-menu__label">File-Manager</span><i class="sub-angle fe fe-chevron-down"></i></a>
                    <ul class="sub-slide-menu">
                      <li>
                        <a class="sub-side-menu__item" href="file-manager.html">File-Manager</a>
                      </li>
                      <li>
                        <a class="sub-side-menu__item" href="file-manager-list.html">File-Manager-List</a>
                      </li>
                      <li>
                        <a class="sub-side-menu__item" href="file-manager-details.html">File-Manager-Details</a>
                      </li>
                      <li>
                        <a class="sub-side-menu__item" href="file-attachments.html">File-Attachments</a>
                      </li>
                    </ul>
                  </li>
                </ul>
              ...
              <li class="slide">
                ...
                <ul class="slide-menu">
                  ...
                  <li>
                    <a class="slide-item" href="scrollspy.html">Scrollspy</a>
                  </li>
                </ul>
              </li>
              <li class="slide">
                ...
                <ul class="slide-menu">
                  ...
                  <li class="sub-slide">
                    <a class="slide-item" data-bs-toggle="sub-slide" href="javascript:void(0);"><span
                        class="sub-side-menu__label">Blog-Pages</span><i class="sub-angle fe fe-chevron-down"></i></a>
                    <ul class="sub-slide-menu">
                      <li>
                        <a class="sub-side-menu__item" href="blog.html">Blog</a>
                      </li>
                      <li>
                        <a class="sub-side-menu__item" href="blog-details.html">Blog-Details</a>
                      </li>
                      <li>
                        <a class="sub-side-menu__item" href="edit-post.html">Blog-Edit</a>
                      </li>
                    </ul>
                  </li>
                </ul>
              ...
              <li class="slide">
                ...
                <ul class="slide-menu">
                  ...
                  <li>
                    <a class="slide-item" href="javascript:void(0);">Level-1</a>
                  </li>
                  <li class="sub-slide">
                    <a class="slide-item" data-bs-toggle="sub-slide" href="javascript:void(0);"><span
                        class="sub-side-menu__label">Level-2</span><i class="sub-angle fe fe-chevron-down"></i></a>
                    <ul class="sub-slide-menu">
                      <li>
                        <a class="sub-side-menu__item" href="javascript:void(0);">Level-2.1</a>
                      </li>
                      <li>
                        <a class="sub-side-menu__item" href="javascript:void(0);">Level-2.2</a>
                      </li>
                      <li class="sub-slide2">
                        ...
                        <ul class="sub-slide-menu1">
                          <li>
                            <a class="sub-slide-item2" href="javascript:void(0);">Level-2.3.1</a>
                          </li>
                          <li>
                            <a class="sub-slide-item2" href="javascript:void(0);">Level-2.3.2</a>
                          </li>
                          <li>
                            <a class="sub-slide-item2" href="javascript:void(0);">Level-2.3.3</a>
                          </li>
                        </ul>
                      </li>
                    </ul>
              ...
              <li class="slide">
                ...
                <ul class="slide-menu">
                  ...
                  <li>
                    <a class="slide-item" href="form-sizes.html">Form-Sizes</a>
                  </li>
                </ul>
              </li>
              <li class="slide">
                ...
                <ul class="slide-menu">
                  ...
                  <li>
                    <a class="slide-item" href="edit-table.html">Edit Tables</a>
                  </li>
                </ul>
              </li>
              <li class="slide">
