                        ...
                        <div class="main-header-right">
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <li
                                            class="dropdown nav-item main-layout"
                                        >
                                            <a
                                        ...
                                        <li
                                            class="nav-link search-icon d-lg-none d-block"
                                        >
                                            <form
                                                class="navbar-form"
                                                role="search"
                  ...
                  >
                                ...
                                <li class="slide">
                                    ...
                                    <ul class="slide-menu">
                                        <li class="side-menu__label1">
                                            <a href="javascript:void(0);"
                                                >Product SubCatogory</a
                                            >
                                        </li>
                                        <li>
                                            <a
                                                class="slide-item"
                                                href="addProductSubCatogory.html"
                                                ...
                                                <li class="sub-slide2">
                                                    <a
                                                        ...
                                                        ><span
                                                            ...
                                                            >Level-2.3</span
                                                        ><i
                                                            class="sub-angle2 fe fe-chevron-down"
                                                        ></i
                                                    ></a>
                        ...
                        <div class="col-lg-8 col-xl-8 col-md-12 col-sm-12">
                            <div class="card box-shadow-0">
                                <div class="card-header">
                                    ...
                                    <p class="mb-2">
                                        Enter the name of the subcategory you
                                        want to add
                                    </p>
                                </div>
                                    ...
                                    >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small class="form-text text-muted">
                                                Enter the subcategory's official
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small class="form-text text-muted">
                                                ...
                                                about this subcategory. Optional
                                                field.
                                            </small>
                                        </div>
                                        <!-- Submit and Reset Buttons -->
                                        <div
                                            class="form-group mb-0 mt-3 justify-content-end"
                                        >
                                            <div>
                                                <button
                                                    type="submit"
            ...
            <div class="main-footer ht-45">
                <div class="container-fluid pd-t-0 ht-100p">
                    <span>
                        ...
                        >Builder.lk Designed with
                        <span class="fa fa-heart text-danger"></span> by
                        <a href="javascript:void(0);"> AAIC </a> All rights
                        reserved.</span
                    >
                </div>
            </div>
