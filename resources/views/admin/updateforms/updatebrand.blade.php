                ...
                <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                    <div class="card box-shadow-0">
                        ...
                        <div class="card-body pt-0">
                            <form action="{{ url('brand/update', $brand->id) }}" method="POST" class="form-horizontal"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="b_name"
                                            value="{{ $brand->b_name }}" id="brand_name" placeholder="Brand Name"
                                            required />
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="country_of_origin"
                                            value="{{ $brand->country_of_origin }}" id="country_of_origin"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="mb-4">
                                                ...
                                                <select multiple="multiple" name="product[]" class="selectsum1">
                                                ...
                                                <small class="form-text text-muted">Choose one product for this Brand.
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <img src="{{ asset('assets/brand/' . $brand->brand_img) }}" height="200px"
                                            alt="Brand_Image">

                                        <input class="form-control" type="file" id="brand_img" name="brand_img"
                                            accept=".jpg,.jpeg,.png" onchange="previewImage()" required />
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select id="product_source" name="production" class="form-control" required>
                                            <option value="" disabled selected>
                                                Select Product Source
                                            </option>
                                            <option value="imported" {{ $brand->production == 'imported' ? 'selected' : '' }}>
                                                Imported</option>
                                            <option value="manufactured"
                                                {{ $brand->production == 'manufactured' ? 'selected' : '' }}>Manufactured
                                            </option>
                                            <option value="deal" {{ $brand->production == 'deal' ? 'selected' : '' }}>
                                                Deal/Distribute</option>
                                        </select>
                                        <small class="form-text text-muted">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control" id="description" name="description" rows="4"
                                            placeholder="Enter technical details here..." required>{{ $brand->description }}</textarea>
                                        <small class="form-text text-muted">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" class="form-control" name="company_name"
                                            value="{{ $brand->company_name }}" id="company_name" placeholder="Company Name"
                                            required />
                                        <small class="form-text text-muted">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" class="form-control" name="br" id="br"
                                            value="{{ $brand->br }}" placeholder="Business Registration" required />
                                        <small class="form-text text-muted">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" id="address" value="{{ $brand->address }}" name="address"
                                        rows="3" placeholder="Enter Copmany Address.." required></textarea>
                                    <small class="form-text text-muted">Provide the full address for this brand's main
                                        office.
                                        Required field.</small>
                                </div>
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="tel" class="form-control" id="contact_Person"
                                            name="contact_Person" placeholder="Enter Your Contact Person"
                                            value="{{ $brand->contact_Person }}" required />
                                        <small class="form-text text-muted">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="tel" class="form-control" id="designation" name="designation"
                                            placeholder="Enter Your Designation" value="{{ $brand->designation }}"
                                            required />
                                        <small class="form-text text-muted">
                                            Enter Designation.
                                            Required field.
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="tel" class="form-control" id="whatsapp_no" name="whatsapp_no"
                                            value="{{ $brand->whatsapp_no }}" placeholder="Enter Your Whatsapp Number"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="tel" class="form-control" id="contact_no"
                                            name="brand_contact_number" value="{{ $brand->brand_contact_number }}"
                                            placeholder="Enter Your Contact Number" pattern="[0-9]{10}" required />
                                        <small class="form-text text-muted">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="tel" class="form-control" id="b_email"
                                            value="{{ $brand->b_email }}" name="b_email" placeholder="Enter Your  Email"
                                            required />
                                        <small class="form-text text-muted">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="tel" class="form-control" id="web_link" name="b_web_link"
                                            value="{{ $brand->b_web_link }}" placeholder="Enter Your Web Link"
                                            required />
                                        <small class="form-text text-muted">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody id="directors-table-body">
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="text" name="directors[${rowCount}][name]"
                                                        class="form-control" placeholder="Enter Name" required />
                                                </td>
                                                <td>
                                                    <input type="text" name="directors[${rowCount}][contact]"
