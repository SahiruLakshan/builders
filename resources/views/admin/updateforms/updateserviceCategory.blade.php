        ...
        <div class="col-lg-8 col-xl-8 col-md-12 col-sm-12">
            <div class="card box-shadow-0">
                <div class="card-header">
                    <h4 class="card-title mb-1">Update Services </h4>
                    <p class="mb-2">
                        Enter the name of the Service you want to Update
                    </p>
                </div>
                <div class="card-body pt-0">
                    <form action="{{url('update/updateservice')}}" method="POST" class="form-horizontal" id="addproduct">
                        @csrf
                        <!-- Service Name Field -->
