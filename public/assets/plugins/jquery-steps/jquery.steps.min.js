    ...
    function L(a, b, c) {
        if (b.enablePagination) {
            var d =
                ...
                e = '<li><a href="#{0}" id="{1}" role="menuitem">{2}</a></li>',
                f = "";
            b.forceMoveForward ||
                (f += e.format(
                    "previous",
                ...
                (f += e.format("next", "next-button", b.labels.next)),
                b.enableFinishButton &&
                    (f += e.format("finish", "submit-button", b.labels.finish)),
                b.enableCancelButton &&
                    (f += e.format("cancel", "cancel-button", b.labels.cancel)),
                a.append(
                    d.format(
